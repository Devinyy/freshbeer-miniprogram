...
<style scoped>.page{height:100vh;display:flex;flex-direction:column;background:var(--color-bg)}.content{flex:1;padding:12px 16px}.form{padding:0}.row{display:flex;align-items:center;min-height:50px;border-bottom:1px solid var(--color-border-light);padding:0 12px}.row:last-child{border:0}.label{width:72px;font-size:14px}.row input{flex:1;text-align:right;font-size:14px}.save{margin-top:20px;background:var(--color-primary);color:#fff}.empty{padding:40px;text-align:center;color:var(--color-text-secondary)}</style>
